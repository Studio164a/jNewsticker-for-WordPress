...
class jNewsticker_Recent_Posts extends jNewsticker_Data_Source {
    ...
    public function get_settings() {
        ...
        foreach ( $taxonomies as $taxonomy => $details ) {
            ...
            // To show all terms (including hidden):
            //
            // function jnewsticker_post_taxonomy_terms_args_filter($default) { 
            //     return array('hide_empty' => false);
            // }
            // add_filter('jnewsticker_post_taxonomy_terms_args', 'jnewsticker_post_taxonomy_terms_args_filter');
            $terms = get_terms( $taxonomy, apply_filters('jnewsticker_post_taxonomy_terms_args', array(), $taxonomy ) );
