...
(function( $ ) {
    ...
    $.fn.newsticker.styles = {
        ...
        scroll : {
            ...
            // Returns the new x coordinate of the current item
            getNewX : function() {
                var wrapperWidth = this.dom.wrapper.width(), 
                    progress = this.progress, 
                    lastItem = progress.last, 
                    outer = lastItem.position().left + lastItem.outerWidth(false);

                if ( typeof this.isShort === "undefined" ) {
                    this.isShort = outer < wrapperWidth;
                }

                if ( this.isShort ) {

                    if ( typeof this.rightBound === "undefined" ) {
                        this.rightBound = wrapperWidth - lastItem.outerWidth(false);                        
                    }
                    
                    return progress.left * -1 + this.rightBound;
                }
