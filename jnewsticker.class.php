...
class jNewsticker {       
    ...
    public function display_form() {
            ...
            <div class="<?php echo in_array( $_GET['m'], array( 'ticker_update_failed' ) ) ? 'error' : 'updated' ?>">
                ...
                <?php switch ( $_GET['m'] ) : 
                    ...
                    case 'ticker_update_failed' :
                        printf( __( '%sOops%s. Something went wrong while updating the newsticker.', 'jnews'), '<strong>', '</strong>');
                        break;
                endswitch ?>
                </p>
            </div>
        ...
        <form method="post" action="<?php echo admin_url('options-general.php?page=jnewsticker') ?>" class="newsticker_form">
            ...
            <div class="button-container">
                <input type="submit" value="<?php _e('Save jNewsticker', 'jnews') ?>" class="button-primary" name="save_jnewsticker" />
            </div>
    ...
    public function display( $echo = true ) {
        ...
        // Don't show anything when there are no list items
